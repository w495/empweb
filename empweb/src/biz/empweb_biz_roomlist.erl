...
%%
%%          Зависит от модуля empdb_biz_roomlist. Все внешние функуции принимают
%%              proplist()
%%          и возвращают:
%%              {ok, [Obj::{proplist()}]}
%%              |   {error, Reason::atom()}
...
create(Params)->
    empdb_biz_roomlist:create(Params).

update(Params)->
    empdb_biz_roomlist:update(Params).

count(Params)->
    empdb_biz_roomlist:count(Params).
    
get(Params)->
    empdb_biz_roomlist:get(Params).
