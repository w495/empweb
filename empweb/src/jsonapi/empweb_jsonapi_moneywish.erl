...
-module(empweb_jsonapi_moneywish).
...
handle(_req, #empweb_hap{
    ...
    ?evman_args([Hap], <<" = create moneywish">>),
    empweb_jsonapi:handle_params(
        %% проверка входных параметров и приведение к нужному типу
        norm:norm(Params, [
            #norm_rule{
...
handle(_req, #empweb_hap{
    ...
    ?evman_args([Hap], <<" = update moneywish">>),
