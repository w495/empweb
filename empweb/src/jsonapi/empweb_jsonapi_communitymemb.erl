...
-module(empweb_jsonapi_communitymemb).
...
handle(_req, #empweb_hap{
    ...
    ?evman_args([Hap], <<" = get communitymemb">>),
...
handle(_req, #empweb_hap{
    ...
    ?evman_args([Hap], <<" = create communitymemb">>),
    empweb_jsonapi:handle_params(
        %% проверка входных параметров и приведение к нужному типу
        norm:norm(Params, [
            #norm_rule{
        ...
        fun(Data)->
            ...
            {ok,
                empweb_jsonapi:resp(
                    empweb_biz_communitymemb:create([
                        {owner_id, Pers_id}
                        |Data#norm.return
                    ])
                ),
...
handle(_req, #empweb_hap{
    ...
    ?evman_args([Hap], <<" = update communitymemb">>),
    ...
    empweb_jsonapi:handle_params(
        ...
        fun(Data)->
            ...
            {ok,
                empweb_jsonapi:resp(
                    empweb_biz_communitymemb:update([
                        {owner_id, Pers_id}
                        |Data#norm.return
                    ])
                ),
...
handle(_req, #empweb_hap{
    ...
    empweb_jsonapi:handle_params(
        ...
        fun(Data)->
            ...
            {ok,
                empweb_jsonapi:resp(
                    empweb_biz_communitymemb:delete([
                        {owner_id, Pers_id}
                        |Data#norm.return
                    ])
                ),
