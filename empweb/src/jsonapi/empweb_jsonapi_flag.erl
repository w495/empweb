...
handle(_req, #empweb_hap{
    ...
    empweb_jsonapi:handle_params(
        ...
        fun(Data)->
            ...
            {ok,
                empweb_jsonapi:resp(
                    empweb_biz_flag:get(Data#norm.return)
                ),
                Hap
            }
        end
...
handle(_req, #empweb_hap{
    ...
    empweb_jsonapi:handle_params(
        ...
        fun(Data)->
            ...
            {ok,
                empweb_jsonapi:resp(
                    empweb_biz_flag:create(Data#norm.return)
                ),
                Hap
            }
        end
...
handle(_req, #empweb_hap{
    ...
    empweb_jsonapi:handle_params(
        ...
        fun(Data)->
            ...
            {ok,
                empweb_jsonapi:resp(
                    empweb_biz_flag:repost(Data#norm.return)
                ),
                Hap
            }
        end
...
handle(_req, #empweb_hap{
    ...
    empweb_jsonapi:handle_params(
        ...
        fun(Data)->
            ...
            {ok,
                empweb_jsonapi:resp(
                    empweb_biz_flag:update(Data#norm.return)
                ),
                Hap
            }
        end
...
handle(_req, #empweb_hap{
    ...
    empweb_jsonapi:handle_params(
        ...
        fun(Data)->
            ...
            {ok,
                empweb_jsonapi:resp(
                    empweb_biz_flag:delete(Data#norm.return)
                ),
                Hap
            }
        end
