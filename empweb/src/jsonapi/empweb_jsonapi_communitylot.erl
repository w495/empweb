...
-module(empweb_jsonapi_communitylot).
...
handle(_req, #empweb_hap{
    ...
    ?evman_args([Hap], <<" = create communitylot">>),
    empweb_jsonapi:handle_params(
        %% проверка входных параметров и приведение к нужному типу
        norm:norm(Params, [
            #norm_rule{
        ...
        fun(Data)->
            ...
            {ok,
                empweb_jsonapi:resp(
                    empweb_biz_communitylot:create([
                        {owner_id, Pers_id}
                        |Data#norm.return
                    ])
                ),
...
handle(_req, #empweb_hap{
    ...
    ?evman_args([Hap], <<" = update communitylot">>),
    ...
    empweb_jsonapi:handle_params(
        ...
        fun(Data)->
            ...
            {ok,
                empweb_jsonapi:resp(
                    empweb_biz_communitylot:update([
                        {owner_id, Pers_id}
                        |Data#norm.return
                    ])
                ),
...
handle(_req, #empweb_hap{
    ...
    empweb_jsonapi:handle_params(
        ...
        fun(Data)->
            ...
            {ok,
                empweb_jsonapi:resp(
                    empweb_biz_communitylot:delete([
                        {owner_id, Pers_id}
                        |Data#norm.return
                    ])
                ),
