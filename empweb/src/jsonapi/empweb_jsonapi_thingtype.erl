...
-module(empweb_jsonapi_thingtype).
...
handle(_req, #empweb_hap{
    ...
    empweb_jsonapi:handle_params(
        ...
        fun(Data)->
            ...
            {ok,empweb_jsonapi:resp(empweb_biz_thingtype:get(Data#norm.return)),Hap}
        end
    );
...
handle(_req, #empweb_hap{
    ...
    empweb_jsonapi:handle_params(
        ...
        fun(Data)->
            ?evman_debug(Data, <<" = Data">>),
            {ok,empweb_jsonapi:resp(empweb_biz_thingtype:create(Data#norm.return)),Hap}
        end
    );
...
handle(_req, #empweb_hap{
    ...
    empweb_jsonapi:handle_params(
        ...
        fun(Data)->
            ?evman_debug(Data, <<" = Data">>),
            {ok,empweb_jsonapi:resp(empweb_biz_thingtype:update(Data#norm.return)),Hap}
        end
    );
...
handle(_req, #empweb_hap{
    ...
    ?evman_args([Hap], <<" = delete thingtype">>),
    ...
    empweb_jsonapi:handle_params(
        ...
        fun(Data)->
            ?evman_debug(Data, <<" = Data">>),
            {ok,empweb_jsonapi:resp(empweb_biz_thingtype:delete(Data#norm.return)),Hap}
        end
    );
