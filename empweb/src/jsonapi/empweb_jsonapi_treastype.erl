...
-module(empweb_jsonapi_treastype).
...
handle(_req, #empweb_hap{
    ...
    ?evman_args([Hap], <<" = create treastype">>),
    empweb_jsonapi:handle_params(
        %% проверка входных параметров и приведение к нужному типу
        norm:norm(Params, [
            #norm_rule{
...
handle(_req, #empweb_hap{
    ...
    ?evman_args([Hap], <<" = update treastype">>),
