...
-module(empweb_jsonapi_experbuy).
...
handle(_req, #empweb_hap{
    ...
    ?evman_args([Hap], <<" = create experbuy">>),
    empweb_jsonapi:handle_params(
        %% проверка входных параметров и приведение к нужному типу
        norm:norm(Params, [
            #norm_rule{
...
handle(_req, #empweb_hap{
    ...
    ?evman_args([Hap], <<" = update experbuy">>),
