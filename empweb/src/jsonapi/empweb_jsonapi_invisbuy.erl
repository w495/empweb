...
-module(empweb_jsonapi_invisbuy).
...
handle(_req, #empweb_hap{
    ...
    ?evman_args([Hap], <<" = create invisbuy">>),
    empweb_jsonapi:handle_params(
        %% проверка входных параметров и приведение к нужному типу
        norm:norm(Params, [
            #norm_rule{
...
handle(_req, #empweb_hap{
    ...
    ?evman_args([Hap], <<" = update invisbuy">>),
