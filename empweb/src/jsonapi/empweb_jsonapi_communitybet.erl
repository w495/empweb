...
-module(empweb_jsonapi_communitybet).
...
handle(_req, #empweb_hap{
    ...
    ?evman_args([Hap], <<" = get communitybet">>),
...
handle(_req, #empweb_hap{
    ...
    ?evman_args([Hap], <<" = create communitybet">>),
    empweb_jsonapi:handle_params(
        %% проверка входных параметров и приведение к нужному типу
        norm:norm(Params, [
            #norm_rule{
        ...
        fun(Data)->
            ...
            {ok,
                empweb_jsonapi:resp(
                    empweb_biz_communitybet:create([
                        {owner_id, Pers_id}
                        |Data#norm.return
                    ])
                ),
...
handle(_req, #empweb_hap{
    ...
    ?evman_args([Hap], <<" = update communitybet">>),
    ...
    empweb_jsonapi:handle_params(
        ...
        fun(Data)->
            ...
            {ok,
                empweb_jsonapi:resp(
                    empweb_biz_communitybet:update([
                        {owner_id, Pers_id}
                        |Data#norm.return
                    ])
                ),
