...
handle(_req, #empweb_hap{
    ...
    empweb_jsonapi:handle_params(
        ...
        fun(Data)->
            ...
            {ok,
                empweb_jsonapi:resp(
                    empweb_biz_back:get(Data#norm.return)
                ),
                Hap
            }
        end
...
handle(_req, #empweb_hap{
    ...
    empweb_jsonapi:handle_params(
        ...
        fun(Data)->
            ...
            {ok,
                empweb_jsonapi:resp(
                    empweb_biz_back:create(Data#norm.return)
                ),
                Hap
            }
        end
...
handle(_req, #empweb_hap{
    ...
    empweb_jsonapi:handle_params(
        ...
        fun(Data)->
            ...
            {ok,
                empweb_jsonapi:resp(
                    empweb_biz_back:repost(Data#norm.return)
                ),
                Hap
            }
        end
...
handle(_req, #empweb_hap{
    ...
    empweb_jsonapi:handle_params(
        ...
        fun(Data)->
            ...
            {ok,
                empweb_jsonapi:resp(
                    empweb_biz_back:update(Data#norm.return)
                ),
                Hap
            }
        end
...
handle(_req, #empweb_hap{
    ...
    empweb_jsonapi:handle_params(
        ...
        fun(Data)->
            ...
            {ok,
                empweb_jsonapi:resp(
                    empweb_biz_back:delete(Data#norm.return)
                ),
                Hap
            }
        end
