...
handle(_req, #empweb_hap{
    ...
    ?evman_args([Hap], <<" = get experpurchase">>),
...
handle(_req, #empweb_hap{
    ...
    ?evman_args([Hap], <<" = create experpurchase">>),
    jsonapi:handle_params(
        %% проверка входных параметров и приведение к нужному типу
        norm:norm(Params, [
            #norm_rule{
...
handle(_req, #empweb_hap{
    ...
    ?evman_args([Hap], <<" = update experpurchase">>),
