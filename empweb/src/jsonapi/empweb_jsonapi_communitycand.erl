...
-module(empweb_jsonapi_communitycand).
...
handle(_req, #empweb_hap{
    ...
    ?evman_args([Hap], <<" = get communitycand">>),
...
handle(_req, #empweb_hap{
    ...
    ?evman_args([Hap], <<" = create communitycand">>),
    empweb_jsonapi:handle_params(
        %% проверка входных параметров и приведение к нужному типу
        norm:norm(Params, [
            #norm_rule{
        ...
        fun(Data)->
            ...
            {ok,
                empweb_jsonapi:resp(
                    empweb_biz_communitycand:create([
                        {owner_id, Pers_id}
                        |Data#norm.return
                    ])
                ),
...
handle(_req, #empweb_hap{
    ...
    ?evman_args([Hap], <<" = update communitycand">>),
    ...
    empweb_jsonapi:handle_params(
        ...
        fun(Data)->
            ...
            {ok,
                empweb_jsonapi:resp(
                    empweb_biz_communitycand:update([
                        {owner_id, Pers_id}
                        |Data#norm.return
                    ])
                ),
...
handle(_req, #empweb_hap{
    ...
    empweb_jsonapi:handle_params(
        ...
        fun(Data)->
            ...
            {ok,
                empweb_jsonapi:resp(
                    empweb_biz_communitycand:delete([
                        {owner_id, Pers_id}
                        |Data#norm.return
                    ])
                ),
