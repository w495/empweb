...
-module(empweb_jsonapi_roomtreas).
...
handle(_req, #empweb_hap{
    ...
    empweb_jsonapi:handle_params(
        ...
        fun(Data)->
            ...
            {ok,
                empweb_jsonapi:resp(
                    empweb_biz_roomtreas:get(Data#norm.return)
                ),
                Hap
            }
        end
...
handle(_req, #empweb_hap{
    ...
    ?evman_args([Hap], <<" = create roomtreas">>),
    empweb_jsonapi:handle_params(
        %% проверка входных параметров и приведение к нужному типу
        norm:norm(Params, [
            #norm_rule{
        ...
        fun(Data)->
            ...
            {ok,
                empweb_jsonapi:resp(
                    empweb_biz_roomtreas:create(Data#norm.return)
                ),
                Hap
            }
        end
...
handle(_req, #empweb_hap{
    ...
    ?evman_args([Hap], <<" = update roomtreas">>),
    ...
    empweb_jsonapi:handle_params(
        ...
        fun(Data)->
            ...
            {ok,
                empweb_jsonapi:resp(
                    empweb_biz_roomtreas:update(Data#norm.return)
                ),
                Hap
            }
        end
