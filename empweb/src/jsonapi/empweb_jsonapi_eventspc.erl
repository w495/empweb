...
-module(empweb_jsonapi_eventspc).
...
handle(_req, #empweb_hap{
    ...
    ?evman_args([Hap], <<" = create eventspc">>),
    empweb_jsonapi:handle_params(
        %% проверка входных параметров и приведение к нужному типу
...
handle(_req, #empweb_hap{
    ...
    ?evman_args([Hap], <<" = update eventspc">>),
