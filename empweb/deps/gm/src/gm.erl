...
bind_data(Template, [{Key, Value}|Rest], Options) when erlang:is_binary(Value) ->
    bind_data(Template, [{Key,  erlang:binary_to_list(Value)}|Rest], Options);
