...
with_connection(Function) ->
    psqlcp:with_connection(fk, Function).

%%
%%
%%
with_transaction(Function) ->
    psqlcp:with_transaction(fk, Function).
...
%%%
equery(Con, Query, Params) when erlang:is_list(Query) ->
...
equery(Con, Query) when erlang:is_list(Query) ->
