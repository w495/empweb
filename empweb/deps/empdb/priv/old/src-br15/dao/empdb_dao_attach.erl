...
get(Con, What) ->
    ...
    %         "   join attach on attach.doc_id = doc.id "
    %         "   join file on file.id = attach.file_id "
    ...
    Fields =
        case Truefields of
            [] ->
                lists:append([
                    empdb_dao_attach:table({fields, select}),
    ...
    case empdb_dao:get([
        {empdb_dao_doc, id},
        {empdb_dao_attach, {doc_id, file_id}},
        {empdb_dao_file, id},
